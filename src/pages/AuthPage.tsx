    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4">
      <div className="w-full max-w-sm space-y-8">
        <div className="text-center">
          <img src={logo} alt="Zero Gifts" className="h-16 w-16 mx-auto mb-3 object-contain" />
          <h1 className="font-display text-3xl font-bold text-foreground">Zero Gifts</h1>
        ...
        <form onSubmit={handleEmailAuth} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={submitting}
            className="w-full bg-primary text-primary-foreground py-3 rounded-full font-semibold shadow-rose hover:opacity-90 transition-opacity disabled:opacity-50"
          >
